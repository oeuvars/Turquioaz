   ...
   return (
      <>
         {isAboveSmallScreens ? (
            ...
            <div>
               <p className="font-dm-mono text-center uppercase font-medium my-[1vh]">
         ...
         <div className="grid tablet:grid-cols-[1fr_3fr] mt-[1.75vw] w-[98%] mx-auto gap-1">
            {isAboveSmallScreens ? (
               <DesktopFilters
                  setPage={setPage}
                  selectedBrand={selectedBrand}
         ...
         <div className="phone:my-[3vh] lg:my-[3vw] flex gap-3 justify-center">
            <button
               className={`mr-1 ${page === 1 ? 'cursor-not-allowed' : ''}`}
               onClick={() => {
                  if (page !== 1) {
                     setPage(page - 1);
                  }
               ...
               if (isMiddleButton || isInRange) {
                  return (
                     <button
                        ...
                        className={`${
                           isMiddleButton ? 'bg-[#1F1F1F] text-yellow-600' : 'bg-[#282828]'
            ...
            <button
               className={`ml-1 ${page === totalPages ? 'cursor-not-allowed' : ''}`}
               onClick={() => {
