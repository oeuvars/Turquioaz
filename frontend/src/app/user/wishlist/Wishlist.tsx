                     ...
                     <AnimatePresence>
                        <motion.div className="grid lg:grid-cols-2 gap-5 mt-[5vw]">
                           {wishlistedModels.map((wishlistedModel: WishlistedModel) => (
                              <Link to={`/the-collection/all-cars/${wishlistedModel.model.id}`} className="relative rounded-sm overflow-hidden phone:h-[40vh] md:h-[40vw]">
                                 <img src={wishlistedModel.model.imageSource} alt="" className=" w-full mx-auto object-cover opacity-70 absolute -z-10 phone:h-[40vh] md:h-[40vw]"/>
