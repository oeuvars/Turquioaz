...
const ContactUs: React.FC = () => {
  return (
    <div className='min-h-screen flex flex-col justify-between'>
      <Navbar />
      <div className='grid tablet:grid-cols-[2fr_1fr] phone:gap-7 tablet:gap-5 w-[98%] mx-auto md:h-[90vh]'>
         <video
            autoPlay
            loop
         ...
         <div className='flex flex-col justify-center phone:gap-3 md:gap-10 h-full phone:w-[95%] tablet:w-full mx-auto'>
            ...
            <div className='flex flex-col gap-2'>
               ...
               <Button className='bg-[#222222] py-2 w-full rounded mt-5'>Submit</Button>
            </div>
         </div>
      </div>
      <div className='phone:mt-10 md:mt-[2vw]'>
         <Footer />
      </div>
    </div>
  )
