                                    ...
                                    <div className='mx-auto flex flex-col phone:h-[40vh] xs:h-[50vh] s:h-[55vh] sm:h-[60vh] md:h-[40vw] justify-between w-full absolute z-10'>
                                       <div className='flex justify-between phone:p-[1.5vh] md:p-[1vw]'>
                                          ...
                                          <div className="flex gap-3">
                                             <p className="phone:text-sm tablet:text-base tracking-tight text-[#FAFAFA]">{wishlist.car.brand}</p>
                                             <p className="phone:text-sm tablet:text-base tracking-tight text-[#BBBBBB]">{wishlist.car.name}</p>
                                          </div>
                                       </div>
