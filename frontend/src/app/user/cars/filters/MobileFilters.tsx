   ...
   useEffect(() => {
      const getResponse = async () => {
         const response = await axios.get(
            'https://calm-gold-rabbit-gown.cyclic.app/user/total-cars',
            { headers },
         );
      ...
      <Drawer>
         ...
         <DrawerContent className="bg-[#111111]/50 backdrop-blur-xl pb-[2vh]">
            <div className="mx-auto w-[90%]">
               ...
               <div className="">
                  <p className="gtext-lg tracking-tighter">
                     <span className="gradient-text text-lg">Brand</span>
                  </p>
                        ...
                        <div className="flex flex-wrap gap-2">
                           {allBrands?.map(brand => (
                              <button
                                 ...
                                 className={`text-[#FAFAFA] text-left text-sm tracking-tight animation hover:bg-[#202020] py-1 px-4 rounded-sm ${
               ...
               <div className="mx-auto grid gap-2 rounded py-[1vh] z-20">
                  <p className="text-lg tracking-tighter">
                     <span className="gradient-text text-lg">Price</span>
                  </p>
                  <Slider
               ...
               <div className="mx-auto grid gap-2 rounded py-[1vh] z-20">
                  <p className="tracking-tighter">
                     <span className="gradient-text text-lg">HorsePower</span>
                  </p>
                  <Slider
               ...
               <div className="mx-auto grid gap-2 rounded py-[1vh]">
                  <p className="tracking-tighter">
                     <span className="gradient-text text-lg">Accleration (0-60 MPH)</span>
                  </p>
                  <div className="flex gap-2">
                     <button
