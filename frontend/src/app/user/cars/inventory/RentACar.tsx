      ...
      <>
         ...
         <div className="grid tablet:grid-cols-2 phone:w-[95%] md:w-[98%] md:h-[95vh] mx-auto gap-5 mt-[1vw] mb-[2vw]">
            <img
               ...
               alt=""
               className="w-full mx-auto object-cover phone:h-[45vh] md:h-[95vh] -z-10 opacity-70"
            />
            <div className="flex flex-col">
               ...
               <div className="phone:mt-[1vh] md:mt-[1vw] border border-dashed border-[#555555] rounded p-4 flex justify-between">
                  <h1 className="phone:text-3xl md:text-5xl font-medium tracking-tighter text-[#333333]">
                     Total Cost:
                  </h1>
               ...
               {loginCookie || registerCookie ? (
                  <button
                     onClick={handleClick}
                     className="w-full bg-[#111111] hover:shadow-md animation phone:my-[2vh] md:my-auto py-3 rounded"
                  >
                  ...
                  <Link
                     to="/auth/login"
                     className="w-full bg-[#111111] hover:shadow-md animation phone:my-[2vh] md:my-auto py-3 rounded text-center"
                  >
                     <span className="gradient-text font-medium tracking-tight text-xl">
                        Checkout
                     </span>
