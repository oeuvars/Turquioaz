   ...
   return (
      <AnimatePresence>
         ...
         <motion.div
            ...
            transition={{ type: 'spring', stiffness: 50 }}
            exit={leftVariants.exit}
            className="flex phone:justify-center tablet:justify-end tablet:mr-[15vw] phone:gap-3 md:gap-[2vw] phone:mt-[5vh] md:mt-[1vw]"
         >
         ...
         <motion.div
            ...
            transition={{ type: 'spring', stiffness: 50 }}
            exit={leftVariants.exit}
            className="flex gap-2 tablet:gap-[3vw] phone:justify-center tablet:justify-end phone:mt-[3vh] md:mt-[1vw] tablet:mr-[11vw]"
         >
