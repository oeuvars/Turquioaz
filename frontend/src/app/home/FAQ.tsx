   ...
   const faqs = [
      {
         ...
         answer:
            'Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente, nostrum enim. Nesciunt, quam libero id architecto dolore facere veniam, nemo nihil, autem aliquid qui vitae!',
      },
      {
         id: 2,
            ...
            >
               <Accordion type="single" collapsible className="w-[95%] mx-auto">
                  <AccordionItem value="item-1">
                     ...
                     <AccordionContent className="text-[#DEDEDE] phone:text-sm tablet:text-lg">
                        {faq.answer}
                     </AccordionContent>
                  </AccordionItem>
               </Accordion>
